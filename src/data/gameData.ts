...
export const UNIT_DEFS = [
  ...
  unit("trainee-archer", "Cung Thủ Tập Sự", 1, "Marksman", ["frost"], {
    hp: 450,
    atk: 45,
    atkSpeed: 0.75,
    range: 4,
  ...
  unit("dagger", "Dao Găm", 1, "Assassin", ["assassin"], {
    hp: 500,
    atk: 55,
    atkSpeed: 0.7,
    range: 1,
  ...
  unit("frost-knight", "Hiệp Sĩ Băng", 2, "Tanker", ["fighter", "frost"], {
    hp: 800,
    atk: 50,
    atkSpeed: 0.6,
    range: 1,
  ...
  unit("fire-mage", "Pháp Sư Lửa", 2, "Mage", ["tech"], {
    hp: 500,
    atk: 40,
    atkSpeed: 0.65,
    range: 3,
  ...
  unit("shadow-assassin", "Sát Thủ Bóng", 2, "Assassin", ["assassin", "frost"], {
    hp: 550,
    atk: 60,
    atkSpeed: 0.75,
    range: 1,
  ...
  unit("laser-gunner", "Xạ Thủ Laser", 3, "Marksman", ["tech"], {
    hp: 600,
    atk: 60,
    atkSpeed: 0.8,
    range: 4,
  ...
  unit("frost-warden", "Vệ Thần Băng Giá", 3, "Tanker", ["fighter", "frost"], {
    hp: 950,
    atk: 55,
    atkSpeed: 0.6,
    range: 1,
  ...
  unit("frost-mage", "Pháp Sư Băng", 3, "Mage", ["frost"], {
    hp: 600,
    atk: 50,
    atkSpeed: 0.65,
    range: 3,
  ...
  unit("archmage", "Đại Pháp Sư", 4, "Mage", ["tech"], {
    hp: 700,
    atk: 65,
    atkSpeed: 0.7,
    range: 3,
  ...
  unit("executor", "Hành Quyết Giả", 4, "Assassin", ["assassin"], {
    hp: 750,
    atk: 85,
    atkSpeed: 0.85,
    range: 1,
  ...
  unit("mecha-general", "Đại Tướng Cơ Khí", 5, "Tanker", ["fighter", "tech"], {
    hp: 1100,
    atk: 90,
    atkSpeed: 0.75,
    range: 1,
...
export const CHAPTER_1_LEVEL = {
  ...
  waves: [
    ...
    wave(9, "runner-goblin", 12, 8, 500, { enemyId: "shield-soldier", count: 6 }),
    wave(10, "orc-brute", 1, 10, 1000),
  ],
  bossWaves: [5, 10],
